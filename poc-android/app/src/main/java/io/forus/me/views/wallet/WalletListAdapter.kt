 ...
 */
class WalletListAdapter<T : WalletItem>(lifecycleOwner: LifecycleOwner, private val resource: Int, data: LiveData<List<T>>) : LiveDataAdapter<T, WalletListAdapter.WalletViewHolder>(lifecycleOwner, data) {
